            ...
            <div class="middle-sidebar">
                <ul class="sidebar-list">
                    ...
                    <li class="sidebar-list-item active">
                        <a href="\WDTube\php\content.php" class="sidebar-link active">
                            <svg viewBox="0 0 24 24" class="sidebar-icon active" preserveAspectRatio="xMidYMid meet" focusable="false"><g><path d="M4 6H2v14c0 1.1.9 2 2 2h14v-2H4V6zm16-4H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-8 12.5v-9l6 4.5-6 4.5z"></path></g></svg>
        ...
        <div class="content">
            <div class="headcontent">
                ...
                <div class="table_videos" style="border-bottom-style:solid; padding-top: 10px;">
                    <div>
                        <label style="margin-top:10px; margin-left: 80px; color: #B2BABB;">Video</label>
                        <label class="check_video_column" style="margin-left: 310px;color: #B2BABB;">Date</label>
                        <label class="check_video_column" style="margin-left: 155px;color: #B2BABB;">Views</label>
                        <label class="check_video_column" style="margin-left: 175px;color: #B2BABB;">Comments</label>
                        <label class="check_video_column" style="margin-left: 115px;color: #B2BABB;">Edit</label>
                    </div>
                </div>
                <?php

                $query = "SELECT video_id,video.user_id,video_pic,video_name,video_description,video_code,date,category_id,count_view
                    FROM video
                ...
                <div class="video_container">
                    <div class="video" style="border-bottom-style: solid;">
                        ...
                        <div class="video_column">
                            <div class="video_thumbnail">
                                ...
                                <div class="video_name_css">
                                    <?php
                                    echo '<h2>'.$record['video_name'].'</h2>';
                                    ?>
                                </div>
                                <p>
                                <div class="video_des_css">
                                    <?php
                                    echo '<h2>'.$record['video_description'].'</h2>';
                                    ?>
                                </div>
                                </p>
                            </div>  
                        ...
                        <div class="date_column">
                            <?php
                            echo '<h2>'.$record['date'].'</h2>';
                            ?>
                        </div>
                        <div class="view_column">
                            <?php
                            echo '<h2>'.$record['count_view'].'</h2>';
                            ?>
                        </div>
                        <div class="comment_column">
                            <?php
                            $videoid = $record['video_id'];
                            $comment = mysqli_query($conn, "SELECT * FROM comment WHERE video_id='$videoid'");
                            $count_comment = mysqli_num_rows($comment);
                            echo '<a href="\WDTube\php\view.php?video_code='.$record['video_code'].'"><h2>'.$count_comment.'</h2></a>';
                            ?>
                        </div>
                        <div class="edit_icon">
                            <a href="edit_video_form.php?video_id=<?php echo $record['video_id']?>&category_id=<?php echo $record['category_id']?>">
