...
<head>
    ...
    <title>WDTube</title>
    <link rel="stylesheet" href="/WDTube/css/news/news_about.css">
...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            <img src="/WDTube/img/bg_news.png" style="width:100%;">
            <div class="channel_head">
                <div class="channel_head_next">
                    <img src='/WDTube/img/news_color_64.png' style="margin-top: 15px; margin-left: 100px;">
                    <div class="channel_head_next_text">News</div>
                </div>
                <ul class=" channel_head_text ">
                    <li>
                        <a href=" /WDTube/php/news/news.php" class="channel_head_bar">
                            <div class="channel_head_bar">Home</div>
                        </a>
                    </li>
                    <li>
                        <a href="/WDTube/php/news/news_about.php" class="channel_head_bar">
            ...
            <div class="box">
                <div class="box1">
                    <div class="title">
                        <h5>Description</h5>
                        <h6>
                            YouTube's news destination featuring comprehensive up-to-date coverage on the latest top stories, sports, business,<br>
                ...
                <div class="box2">
                    ...
                    <div class="text"><h6>Joined Sep 9, 2013</h6></div>
                </div>
            </div>
        </div>
</body>
