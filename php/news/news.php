...
?>
    ...
    <head>
        ...
        <title>WDTube</title>
        <link rel="stylesheet" href="/WDTube/css/news/news.css">
        ...
        <div class="container">
            ...
            <div class="content">
                    ...
                    <ul class=" channel_head_text ">
                        <li>
                            <a href="/WDTube/php/news/news.php" class="channel_head_bar">
                                <div class="channel_head_bar">
                                    <div class="channel_head_bar_text_present">Home</div>
                                </div>
                        ...
                        <li>
                            <a href="/WDTube/php/news/news_about.php" class="channel_head_bar">
                                <div class="channel_head_bar">About</div>
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <?php
                    ...
                    $query = 'SELECT * FROM video WHERE category_id=3';
