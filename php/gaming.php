...
?>
    ...
    <head>
        ...
        <title>WDTube</title>
        <link rel="stylesheet" href="/WDTube/css/gaming.css">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="content">
                <img src="/WDTube/img/bg_gaming.png" style="width:100%;">
                <div class="channel_head">
                    <div class="channel_head_next">
                        <img src='/WDTube/img/gaming_color_64.png' style="margin-top:30px;margin-left: 100px;">
                        <div class="channel_head_next_text">เกม</div>
                    </div>
                </div>
                <div class="video-container">
                <?php

                    $query = 'SELECT * FROM video WHERE category_id=2';
