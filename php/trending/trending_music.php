    ...
    <div class="container">
        ...
        <div class="content">
                ...
                <ul class=" channel_head_text ">
                    ...
                    <li>
                        <a href="/WDTube/php/trending/trending_music.php" class="channel_head_bar">
                            <div class="channel_head_bar">
                                <div class="channel_head_bar_text_present">Music</div>
                            </div>
                    ...
                    <li>
                        <a href=" /WDTube/php/trending/trending_game.php" class="channel_head_bar">
                            <div class="channel_head_bar">Gaming</div>
                        </a>
                    </li>
                </ul>
            </div>
            <div class="video-container">
                ...
                $query = 'SELECT * FROM video WHERE category_id="1" ORDER BY count_view DESC,video_name';
